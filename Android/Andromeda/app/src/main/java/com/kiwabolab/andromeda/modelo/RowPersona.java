...
public class RowPersona implements Parcelable
{
    ...
    public final static Creator<RowPersona> CREATOR = new Creator<RowPersona>() {


        @SuppressWarnings({
            "unchecked"
        })
        public RowPersona createFromParcel(Parcel in) {
            return new RowPersona(in);
        }

        public RowPersona[] newArray(int size) {
            return (new RowPersona[size]);
        }

    }
    ;

    protected RowPersona(Parcel in) {
